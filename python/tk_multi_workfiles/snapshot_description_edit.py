...
class SnapshotDescriptionEditBase(QtGui.QTextEdit):
    """
    ...
    def __init__(self, parent):
        ...
        """
        super(SnapshotDescriptionEditBase, self).__init__(parent)
    ...
    def paintEvent(self, paint_event):
        ...
        if not self.hasFocus() and self._show_multiple_values is True:
            ...
            super(SnapshotDescriptionEditBase, self).paintEvent(paint_event)


class SnapshotDescriptionEditQt4(SnapshotDescriptionEditBase):
    """
    Widget that holds the summary description.
    ...
    def __init__(self, parent):
        ...
        :param parent: QT parent object
        """
        super(SnapshotDescriptionEditQt4, self).__init__(parent)
    ...
    def paintEvent(self, paint_event):
        ...
        Paints the line plain text editor and adds a placeholder on bottom right corner when multiple values are detected.
        """
        super(SnapshotDescriptionEditQt4, self).paintEvent(paint_event)
...
if QtCore.qVersion()[0] == "4":
    base = SnapshotDescriptionEditQt4
else:
    base = SnapshotDescriptionEditBase


class SnapshotDescriptionEdit(base):
    pass