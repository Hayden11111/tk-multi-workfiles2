...
"}")
        ...
        self.custom_button = QtGui.QPushButton(FileOpenForm)
...
"}")
    ...
    def retranslateUi(self, FileOpenForm):
        ...
        self.custom_button.setText(QtGui.QApplication.translate("FileOpenForm", "Custom Action", None, QtGui.QApplication.UnicodeUTF8))
